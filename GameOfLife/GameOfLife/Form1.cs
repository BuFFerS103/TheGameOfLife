...
namespace GameOfLife
{
    public partial class Form1 : Form
    {
        ...
        private void pictMute_Click(object sender, EventArgs e)
        {
            PlayMusic();
            pictPlay.Visible = true;
            pictMute.Visible = false;
        }

        private void pictPlay_Click(object sender, EventArgs e)
        {
            StopMusic();
            pictPlay.Visible = false;
            pictMute.Visible = true;
        }

        private void PlayMusic()
        {
            SoundPlayer MusicTheme = new SoundPlayer(GameOfLife.Properties.Resources.MMT);
            MusicTheme.PlayLooping();
        }
